...
fn test_signed() {
...

    {
        ...
        encoder
            .write_tag(Tag::Unknown(65030), SRational { n: -1, d: 100 })
            .unwrap();
        encoder
            .write_tag(
                Tag::Unknown(65031),
                &[SRational { n: -1, d: 100 }, SRational { n: 2, d: 100 }][..],
            )
            .unwrap();
    }
